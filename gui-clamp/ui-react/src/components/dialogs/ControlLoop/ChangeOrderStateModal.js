...
const ChangeOrderStateModal = (props) => {
  ...
  useEffect(async () => {
    ...
    const instantiationOrderState = await ControlLoopService.getInstanceOrderState(props.location.instantiationName, props.location.instantiationVersion, windowLocationPathnameGet)
