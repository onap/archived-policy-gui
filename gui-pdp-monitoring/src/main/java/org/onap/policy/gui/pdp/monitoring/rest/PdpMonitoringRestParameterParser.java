...
public class PdpMonitoringRestParameterParser {
    ...
    public PdpMonitoringRestParameters parse(final String[] args) {
        ...
        try {
            ...
            throw new PdpMonitoringRestParameterException("error parsing argument \"port\" :" + e.getMessage(), e);
        }
        try {
            ...
            throw new PdpMonitoringRestParameterException("error parsing argument \"time-to-live\" :" + e.getMessage(),
                    e);
        }
