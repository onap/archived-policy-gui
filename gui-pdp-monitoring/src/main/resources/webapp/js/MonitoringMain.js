...
function servicesCallback(data){
    ...
    if (engineURL) {
        ...
        if (this.engineURL.hostname === data.server && this.engineURL.port === data.port) {
            setEngineServiceData(data.engine_id, this.groupName, this.subGroupName, data.healthStatus, data.pdpState, data.server, data.port);
            ...
            if(this.engine_id === data.engine_id){
