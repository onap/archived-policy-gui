...
class PolicyUploadDisabledTest {
    ...
    void testModelUploadDisabled() throws Exception {
        ApexApiResult result = apexRequest(get("/apexservices/editor/" + sessionId + "/Model/Upload")
    ...
    private void createSession() throws Exception {
        ApexApiResult result = apexRequest(get("/apexservices/editor/-1/Session/Create"));
    ...
    private void loadModel() throws Exception {
        ...
        apexRequest(put("/apexservices/editor/" + sessionId + "/Model/Load")
