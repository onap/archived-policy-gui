 ...
 * The url to access this resource would be in the form {@code <baseURL>/apexservices/editor/<session>/....},
 * for example: {@code http://localhost:8080/apexservices/editor/109/ContextSchema/Update}<br>
 *
 ...
 * {@code <baseURL>/apexservices/editor/-1/Session/Create}
 */
@RestController
@RequestMapping("/apexservices/editor")
public class ApexEditorRestResource implements RestCommandHandler {
    ...
    @Autowired private RestSessionHandler sessionHandler;

    // Handlers for the various parts of an Apex model
    @Autowired private ModelHandler modelHandler;
    @Autowired private KeyInfoHandler keyInfoHandler;
    @Autowired private ContextSchemaHandler contextSchemaHandler;
    @Autowired private ContextAlbumHandler contextAlbumHandler;
    @Autowired private EventHandler eventHandler;
    @Autowired private TaskHandler taskHandler;
    @Autowired private PolicyHandler policyHandler;
