...
class AcmRuntimeRestTemplateConfig6Test {
    ...
    void expectExceptionWithNoTrustStore(ApplicationContext context) {
        ...
        AcmRuntimeRestTemplateConfig restTemplateConfig = new AcmRuntimeRestTemplateConfig();
        ...
        assertThatExceptionOfType(BeanCreationException.class)
            .isThrownBy(() -> factory.initializeBean(restTemplateConfig, "acmRuntimeRestTemplate"))
